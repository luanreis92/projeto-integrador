...
## Descrição do contexto
  Cibersegurança em redes envolve proteger dados, sistemas e comunicações contra acessos não autorizados. Inclui uso de firewalls, criptografia e monitoramento contínuo. Incidentes comuns abrangem ataques DDoS, phishing, malware, ransomware e invasões. A prevenção depende de boas práticas, atualização de sistemas e conscientização dos usuários para reduzir vulnerabilidades e impactos.
...
## Dashboard Redes
- Gráfico Linha - Volume de tráfego ao longo do tempo.
- Grafico Tabela com alerta - Tentativas repitidas e conexões recusadas.
